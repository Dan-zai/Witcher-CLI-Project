class Witcher::CLI
  ...
  def call
    ...
    puts ""
    puts "Welcome to the Bestiary, young Witcher! The finest collection of creatures and their attributes in all of The Continent".cyan.bold
    puts ""
    menu
    goodbye
  end
  ...
  def monster_menu(chapter, monster)
    menu_prompt = "Want to know about more #{chapter.name}?".cyan
    puts menu_prompt
    input = nil
    while input != "exit"
      input = gets.chomp.downcase
